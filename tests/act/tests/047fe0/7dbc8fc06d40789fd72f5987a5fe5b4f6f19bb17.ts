...
describe("[047fe0]Document has heading for non-repeated content", function () {
  it("Passed Example 5 (https://www.w3.org/WAI/content-assets/wcag-act-rules/testcases/047fe0/7dbc8fc06d40789fd72f5987a5fe5b4f6f19bb17.html)", async () => {
...
<html>
	...
	<body>
		...
		<div id="main">
			<img src="/WAI/content-assets/wcag-act-rules/test-assets/bypass-blocks-cf77f2/peach-garden-oath.jpg" alt="" />
