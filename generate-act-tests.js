...
const skippedExamples = [
  ...
  // [24afc2] avoid-inline-spacing: scanner can't evaluate px values without computed font-size
  "https://www.w3.org/WAI/content-assets/wcag-act-rules/testcases/24afc2/43f8fe88b8e7365db7aa251b263b5d00c7a47ae9.html",

  // [24afc2] avoid-inline-spacing: scanner can't evaluate inherited px spacing against child font-size
  "https://www.w3.org/WAI/content-assets/wcag-act-rules/testcases/24afc2/cabfcae45afac141b38fd9cac2e07a64fb6b9896.html",

  // [24afc2] avoid-inline-spacing: scanner flags parent !important below threshold even when child overrides it
  "https://www.w3.org/WAI/content-assets/wcag-act-rules/testcases/24afc2/d6d5bf7c081939e64d10022dd29f5e31d2153d50.html",

  // [9e45ec] avoid-inline-spacing: scanner can't evaluate px values without computed font-size
  "https://www.w3.org/WAI/content-assets/wcag-act-rules/testcases/9e45ec/2a2a14cc9bcb3fa7983e22f160ce9eeb6b832a8c.html",

  // [9e45ec] avoid-inline-spacing: scanner can't evaluate inherited px spacing against child font-size
  "https://www.w3.org/WAI/content-assets/wcag-act-rules/testcases/9e45ec/15905a239d6755102be6a60aa152ad963d5b1dbb.html",

  // [9e45ec] avoid-inline-spacing: scanner flags parent !important below threshold even when child overrides it
  "https://www.w3.org/WAI/content-assets/wcag-act-rules/testcases/9e45ec/8d2baed183149375922c23a9a5f42b52b627d713.html",

  // [78fd32] avoid-inline-spacing: scanner can't evaluate px values without computed font-size
  "https://www.w3.org/WAI/content-assets/wcag-act-rules/testcases/78fd32/203a13b314695fc2abc6163b3ac7940ab1c4a9ed.html",

  // [78fd32] avoid-inline-spacing: scanner can't evaluate inherited px spacing against child font-size
  "https://www.w3.org/WAI/content-assets/wcag-act-rules/testcases/78fd32/78034759a1086c7ffa8037b6e6e2327ece4a19d7.html",

  // [78fd32] avoid-inline-spacing: scanner can't evaluate % values without computed font-size
  "https://www.w3.org/WAI/content-assets/wcag-act-rules/testcases/78fd32/82c89e74b17e53b55a8d56f23dddbfbe04bc163e.html",

  // [78fd32] avoid-inline-spacing: scanner flags parent !important below threshold even when child overrides it
